...
| kafka | confluentinc/cp-kafka:7.7.8 (KRaft) | always | 1GB / 1.0 CPU |
| spark-stream | apache/spark:3.5.8 | always | 1GB / 1.5 CPU |
| spark (debug) | apache/spark:3.5.8 | always | 1GB / 1.0 CPU |
